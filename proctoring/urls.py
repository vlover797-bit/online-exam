...
urlpatterns = [
    ...
    path('violation_report/<int:attempt_id>/', get_violation_report, name='violation_report'),
    path('proctoring_stats/<int:attempt_id>/', get_proctoring_stats, name='proctoring_stats'),
    path('submit_exam/<int:exam_id>/', submit_exam_with_violations, name='submit_with_violations'),
]
